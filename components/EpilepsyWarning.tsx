...
export default function EpilepsyWarning({ onAccept, onDecline }: Props) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm">
      <div className="max-w-lg mx-4 bg-slate-900 border-2 border-amber-500/50 rounded-2xl p-8 shadow-2xl">
        {/* Warning icon */}
        ...
        <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
          ...
          <p className="text-amber-200/90 font-medium">
            ⚠️ This feature involves <strong>stroboscopic light</strong> that may trigger seizures
